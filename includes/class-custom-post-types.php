...
class Custom_Post_Types {
    ...
    public function register(): void {
        ...
        add_action('add_meta_boxes', [$this, 'add_persona_meta_boxes']);

        // Save meta box data
        add_action('save_post', [$this, 'save_persona_meta']);
    }
    ...
    public function register_post_types(): void {
        ...
        register_post_type($this->persona_post_type, [
            'labels' => [
    ...
    public function add_persona_meta_boxes(): void {
        add_meta_box(
            ...
            [$this, 'render_persona_gender_images_metabox'],
    ...
    public function save_persona_meta(int $post_id): void {
        ...
        if (isset($_POST['persona_image_male'])) {
            ...
            if ($male_image_id) {
                $this->add_tags_to_attachment($male_image_id, ['male', $persona_slug]);
            }
        }
        ...
        if (isset($_POST['persona_image_female'])) {
            ...
            // Add tags to the image
            if ($female_image_id) {
                $this->add_tags_to_attachment($female_image_id, ['female', $persona_slug]);
            }
        }
        ...
        if (isset($_POST['persona_image_indeterminate'])) {
            ...
            if ($indeterminate_image_id) {
                $this->add_tags_to_attachment($indeterminate_image_id, ['indeterminate', $persona_slug]);
            }
        }
    }
    ...
    private function add_tags_to_attachment(int $attachment_id, array $tags): void {
        // Get existing terms
        $existing_terms = wp_get_object_terms($attachment_id, 'media_tag', ['fields' => 'names']);
