...
jQuery(document).ready(function($) {
    ...
    $('#adminmenu li.menu-top.menu-icon-persona > a.menu-top').attr('href', 'edit.php?post_type=persona');
    ...
    $('#adminmenu li.menu-top.menu-icon-persona > a.menu-top').on('click', function(e) {
        e.preventDefault();
